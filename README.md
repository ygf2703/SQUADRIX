...
- `202608010007_club_branding.sql`
   ...
   למאגר שכבר הוגדר עם נתוני הדגמה, הריצו פעם אחת גם את `202608020001_reset_demo_data.sql`. היא מוחקת סגל, משחקים, אימונים, סטטיסטיקות, לוגואים וקישורי מקור קיימים, אך שומרת על המשתמשים ועל ההרשאות.
