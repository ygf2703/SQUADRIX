...
export function MatchesPage() {
  ...
  const addAction = <PermissionGuard roles={['admin', 'professional_staff']}><Link to="/matches/new"><PrimaryButton><Plus size={18}/>הוסף משחק</PrimaryButton></Link></PermissionGuard>;
